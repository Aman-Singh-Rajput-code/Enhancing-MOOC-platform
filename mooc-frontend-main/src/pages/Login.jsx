...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEmail("");
      setPassword("");
      // After storing to localStorage, add a slight delay
setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-teal-500/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/3 w-40 h-40 bg-amber-500/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>

        {/* Floating geometric shapes */}
        <div
          className="absolute top-20 left-20 w-16 h-16 border-2 border-indigo-400/30 rounded-lg transform rotate-45 animate-bounce opacity-30"
          style={{ animationDuration: "6s" }}
        ></div>
        <div
          className="absolute bottom-32 right-48 w-12 h-12 border-2 border-teal-400/30 rounded-full animate-bounce opacity-20"
          style={{ animationDelay: "2.5s", animationDuration: "7s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/5 w-24 h-24 border-2 border-amber-400/30 rounded-md transform rotate-12 animate-bounce opacity-20"
      ...
      <div className="relative z-10 bg-slate-800/70 backdrop-blur-xl rounded-2xl overflow-hidden w-full max-w-md shadow-2xl border border-slate-700/50">
        ...
        <div className="relative">
          ...
          <div className="bg-gradient-to-r from-indigo-800 to-indigo-900 px-8 py-6 border-b border-slate-700/50">
            <div className="mb-2 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-teal-200">
              Login
            </div>
